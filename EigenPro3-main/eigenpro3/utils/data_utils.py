...
def load_cifar10_data(**kwargs):
    train_data = CIFAR10('/lustre/grp/gyqlab/lism/brt/language-vision-interface/N-W-estimator/data', train=True,download=True)
    test_data = CIFAR10('/lustre/grp/gyqlab/lism/brt/language-vision-interface/N-W-estimator/data', train=False,download=True)
